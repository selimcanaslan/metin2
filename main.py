...
class Ui_MainWindow(object):
    ...
    def run_metin2(self):
        ...
        print("cd {}".format(current_path))
        os.system("CD {}".format(current_path))
        os.system("start {}".format("hesap.txt"))
    ...
    def setupUi(self, MainWindow):
        ...
        self.deneme_button = QtWidgets.QPushButton(self.centralwidget)
        self.deneme_button.setGeometry(QtCore.QRect(500, 90, 81, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.deneme_button.setFont(font)
        self.deneme_button.setObjectName("deneme_button")
        self.start_button = QtWidgets.QPushButton(self.centralwidget)
        self.start_button.setGeometry(QtCore.QRect(500, 130, 81, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_14.setGeometry(QtCore.QRect(240, 150, 171, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.menuBoss_Farm = QtWidgets.QMenu(self.menubar)
        self.menuBoss_Farm.setObjectName("menuBoss_Farm")
        MainWindow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(MainWindow)
        self.statusbar.setObjectName("statusbar")
        MainWindow.setStatusBar(self.statusbar)
        self.menubar.addAction(self.menuHome.menuAction())
        self.menubar.addAction(self.menuBoss_Farm.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.deneme_button.setText(_translate("MainWindow", "DENEME"))
        ...
        self.label_14.setText(_translate("MainWindow", "Kostüm Fiyat Hesaplama"))
        ...
        self.menuBoss_Farm.setTitle(_translate("MainWindow", "Boss Farm"))
        ...
        self.deneme_button.clicked.connect(self.path_finder)
        self.start_button.clicked.connect(self.run_metin2)
